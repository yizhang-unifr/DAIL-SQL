...
class prompts_wo_hint_only_sqllike_reparse_ext_atom(prompts1):
...
class prompts_wo_hint_only_sqllike_reparse_ext_atom_step(prompts1):
...
class prompts_wo_hint_no_sqllike(prompts1):
    new_prompt = all_prompt.new_prompt_wo_hint_standQ_newsqllike

class prompts_wo_hint_no_sqllike5(prompts1):
    new_prompt = all_prompt.new_prompt_wo_hint_standQ

class prompts_wo_hint_only_sqllike(prompts1):
    new_prompt = all_prompt.new_prompt1

class prompts_wo_hint_no_sqllike4(prompts1):
